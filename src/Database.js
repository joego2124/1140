...
function findPath(varName, parentName) {
  ...
  if (parentName != undefined) {
    ...
    if (!parent) {
      ...
      console.warn(
        `PARENT ${
          parentNameCleaned != undefined ? parentNameCleaned : parentName
        } NOT FOUND IN RTDB TREE`
      );
    } else {
      // console.log(parent.newPath);
      return findById(parent.obj, varName.toLowerCase(), parent.newPath)
        ?.newPath;
    }
  } else {
