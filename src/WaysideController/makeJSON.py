    ...
    temp.append(
        {
            ...
            'BlockLength': data['Block Length (m)']*3.28084,
            'BlockGrade': data['Block Grade (%)'],
            'SpeedLimit': data['Speed Limit (Km/Hr)']*0.621371,
            'Infrastructure': data['Infrastructure'],
            'Elevation': data['ELEVATION (M)']*3.28084,
            'CumulativeElevation': data['CUMALTIVE ELEVATION (M)'] * 3.28084,
